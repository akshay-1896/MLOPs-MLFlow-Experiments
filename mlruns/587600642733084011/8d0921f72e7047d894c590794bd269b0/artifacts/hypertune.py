...
with mlflow.start_run() as parent:
    ...
    mlflow.sklearn.log_model(grid_search.best_estimator_, "rf-model", registered_model_name="RandomForestClassifier")
    mlflow.log_artifacts("RandomForestClassifier", artifact_path="mlruns/models")

    # Set tags
    mlflow.set_tag("author", "Akshay Sharma")
